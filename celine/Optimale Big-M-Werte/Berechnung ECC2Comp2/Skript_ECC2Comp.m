%% Script to compute ECC2Comp with M_i^{opt} computed with a nodelimit

clear all
%% Adapt MATLAB Path
pathname = fileparts(which('Skript_ECC2Comp.m'));
...
% Computation with new MCS function and intlinprog with bigM
