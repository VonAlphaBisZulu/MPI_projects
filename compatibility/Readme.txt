Makes some functions from newer MATLAB versions available in older ones

contains      - Checks if any member of a cell array matches a certain string
split         - Splits a string into multiple terms by a delimiter
