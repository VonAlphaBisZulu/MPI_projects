cnap = CNAsbmlModel2MFNetwork('C:\Users\Philipp\Documents\Python\mcs\examples\e_coli_core.sbml');
...
modules{1}.c(ismember(cellstr(cnap.reacID),'BIOMASS_Ecoli_core_w_GAM')) = -1;
modules{1}.V = -ismember(cellstr(cnap.reacID),'EX_etoh_e')';
modules{1}.v = -1;
modules{1}.V(2,:) = -2*ismember(cellstr(cnap.reacID),'BIOMASS_Ecoli_core_w_GAM')';
modules{1}.v(2,1) = -0.1;
maxSolutions = inf;
options.milp_bigM = 0;
