...
% cnap.reacMin(ismember(cnap.reacID,{'EX_o2_e'})) = 0;
cnap.reacMin(ismember(cnap.reacID,{'ATPM'})) = 0;
...
% cnap.reacMax(ismember(cnap.reacID,{'ICL'})) = 0;
% cnap.reacMax(ismember(cnap.reacID,{'PDH'})) = 0;
% cnap.reacMax(ismember(cnap.reacID,{'AKGDH'})) = 0;
cnap.reacMin(ismember(cnap.reacID,{'POR5'})) = 0;
% cnap.reacMin(ismember(cnap.reacID,{'ICL'})) = 0;
% cnap.reacMin(ismember(cnap.reacID,{'PDH'})) = 0;
% cnap.reacMin(ismember(cnap.reacID,{'AKGDH'})) = 0;
...
[modules{1}.V(1,:),modules{1}.v(1,:)] = genV([{biomass_rID} {'>='} 0.02 ],cnap);
